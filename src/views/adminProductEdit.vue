  ...
  methods: {
    async fetchAdminProduct(id) {
      try {
        ...
        Toast.fire({
          icon: "error",
          title: "Невозможно получить информацию о продукте, попробуйте немного позже"
        });
      }
    },
    async fetchAdminCategories() {
      try {
        ...
        Toast.fire({
          icon: "error",
          title: "Невозможно получить информацию категории, попробуйте немного позже"
        });
      }
    },
    async handleSubmit(id) {
      try {
        ...
        Toast.fire({
          icon: "error",
          title: "Изменить информацию о продукте не удалось, попробуйте немного позже"
        });
      }
    },
    async deleteImage(e) {
      try {
        ...
        Toast.fire({
          icon: "error",
          title: "Удалить изображение не удалось"
        });
      }
    }
  }
