...
<div class="container pt-5">
  ...
  <!-- <ul class="nav nav-tabs mb-4 mt-2">
    <li class="nav-item">
      <router-link :to="{name:'moderatorProducts'}" class="nav-link">Товары</router-link>
    </li>
  </ul> -->
  <p></p>
</div>
